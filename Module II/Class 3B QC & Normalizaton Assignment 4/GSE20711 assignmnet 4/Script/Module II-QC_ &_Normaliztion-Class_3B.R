...
# 1) Fetch GEO supplementary files (RAW TAR lands in Raw_Data/GSE79973/)
getGEOSuppFiles("GSE79973", baseDir = "Raw_Data", makeDirectory = TRUE)

# 2) Untar CEL files (FIX: correct path includes subfolder GSE79973)
dir.create("Raw_Data/CEL_Files", showWarnings = FALSE, recursive = TRUE)
untar("Raw_Data/GSE79973/GSE79973_RAW.tar", exdir = "Raw_Data/CEL_Files")

# (Do NOT unzip: this series is not a ZIP; keeping your line commented so method stays intact)
# unzip("Raw_Data/E-GEOD-79973.zip", exdir = "Raw_Data/E_GEOD79973")

# Read CEL files into R as an AffyBatch object
raw_data <- ReadAffy(celfile.path = "Raw_Data/CEL_Files")
raw_data   # Displays basic information
# ---------------------------------------------------
