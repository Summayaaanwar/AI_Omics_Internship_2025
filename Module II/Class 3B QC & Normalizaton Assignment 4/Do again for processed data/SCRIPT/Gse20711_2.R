...
local_tar <- "E:/Github/AI_Omics_Internship_2025/Module II/Class 3B QC & Normalizaton Assignment 4/Raw_Data/GSE20711/GSE20711_RAW.tar"
...
# Create output folder if needed (choose one place and be consistent)
dir.create("E:/Github/AI_Omics_Internship_2025/Module II/Class 3B QC & Normalizaton Assignment 4/Processed",
           recursive = TRUE, showWarnings = FALSE)

save_path <- "E:/Github/AI_Omics_Internship_2025/Module II/Class 3B QC & Normalizaton Assignment 4/Processed/GSE20711.RData"

# Save the objects *with these names* so load() restores them:
save(raw_data, normalized_data, processed_data, phenotype_data, feature_data, expression_data,
     file = save_path)

cat("Saved RData to: ", save_path, "\n")
